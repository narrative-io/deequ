...
private[deequ] object SimpleResultSerde {
  ...
  def deserialize(json: String): scala.collection.immutable.Seq[immutable.Map[String, Any]] = {
...
object AnalysisResultSerde {
  ...
  def deserialize(analysisResults: String): scala.collection.immutable.Seq[AnalysisResult] = {
    val gson = new GsonBuilder()
      .serializeSpecialFloatingPointValues()
